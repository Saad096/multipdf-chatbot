...
st.set_page_config(page_title="Custom Knowledge base Chatbot", page_icon=":sparkles:")
st.markdown("<h1 style='text-align: center;'>Saad Alam Chatbot 🌞</h1>", unsafe_allow_html=True)
